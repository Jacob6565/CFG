...
public interface CFGVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CFGParser#if}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIf(CFGParser.IfContext ctx);
	/**
	 * Visit a parse tree produced by {@link CFGParser#elseif}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElseif(CFGParser.ElseifContext ctx);
	/**
	 * Visit a parse tree produced by {@link CFGParser#else}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElse(CFGParser.ElseContext ctx);
	/**
